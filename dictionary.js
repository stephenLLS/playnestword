...
// ── Added v2: missing common words ──
"err","doe","foe","roe","emu","mew",
"race","lace","keep","peep","blew","knew","soar","wear","orca","tore","arcs","cars","oars","rows",
"owes","does","toes","foes","woes","hoes","aces","ices","fare","ware","rode","code","cope","dope",
"mope","pope","ores","ares","errs","roes","iced","eras","egos","emus","bows","cows","dews","hews",
"mews","sews","orbs","bars","jars","tars","wars",
"races","paces","faces","laces","grace","brace","scare","blare","swore","snore","adore","chore",
"drone","phone","prove","crowd","frown","grown","prowl","craft","draft","graft","crave","knave",
"clove","crawl","strew","creep","keeps","peeps","stews","soars","wears","orcas","crows","brows",
"flows","blows","glows","shows","slows","diced","laced","raced","paced","faced","scars","crews",
"acres","cares","cared","dares","dared","bares","bared","fares","fared","hares","mares","wares",
"cores","cored","bores","bored","pores","pored","gores","gored","sores","robes","robed","modes",
"codes","coded","copes","coped","hoped","ropes","roped","dopes","doped","mopes","moped","popes",
"roses","poses","posed","doses","dosed","hoses","hosed","noses","nosed","bowed","hewed","sewed",
"stars","spars","boars","roars",
"places","traces","graces","braces","spaces","scares","scared","stares","stared","shares","shared",
"spares","spared","flares","flared","glares","glared","snares","snared","scores","scored","stores",
"stored","shores","shored","snores","snored","adores","adored","chores","spores","drones","droned",
"stones","stoned","phones","clones","cloned","proves","proved","crowds","frowns","prowls","crafts",
